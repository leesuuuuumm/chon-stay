...
def recommend_villages(
    ...
    for village in villages:
        village_experiences = db.query(Experience).fillter(Experience.village_id == village.id).all()
        village_interests = {e.interest_code for e in village_experiences}
